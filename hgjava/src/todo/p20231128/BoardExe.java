...
public class BoardExe {
	...
	void initData() {
		...
		// boards[2] <--- 5번글등록.
		boards[3] = new Board(4, "네번째 글", "user03", "네번째 글 입력중입니다.", "23-11-28");
		boards[2] = new Board(3, "세번째 글", "user03", "네번째 글 입력중입니다.");

		boards[4] = new Board(5, "다섯번째 글", "user03", "네번째 글 입력중입니다.");
		boards[5] = new Board(6, "여섯번째 글", "user03", "네번째 글 입력중입니다.");
		boards[6] = new Board(7, "일곱번째 글", "user03", "네번째 글 입력중입니다.");
		boards[7] = new Board(8, "여덟번째 글", "user03", "네번째 글 입력중입니다.");
